...
- **ประเภทเอกสาร:** `{DOC_TYPE}` (Monograph / Journal Article / Primary Text / Dissertation)
- **ภาษาของเอกสาร (Language):** `{LANGUAGE}`
- **อักษรที่ใช้ (Script):** `{SCRIPT}`
- **แหล่งสืบค้น / Source URL:** `{SOURCE_URL}`
...
|:---|:---|:---|:---:|
| {ORIGINAL_TERM} | {THAI_TRANSLITERATION} | {DEFINITION} | p. {PAGE} |
