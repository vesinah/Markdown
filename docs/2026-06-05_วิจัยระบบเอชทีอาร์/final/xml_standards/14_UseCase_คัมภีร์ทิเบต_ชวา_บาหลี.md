...
ปัญหาหลักของช่องร้อยเชือกคือ หากเราลากกรอบสี่เหลี่ยม (Bounding Box) คลุมทั้งบรรทัด กรอบนั้นจะพาดผ่านช่องร้อยเชือก ซึ่งอาจจะไปรวมเอาเศษรอยเปื้อน หรือข้อความแทรกอื่นๆ เข้ามาด้วย ในกรณีของ ALTO XML แบบดั้งเดิม นี่คือปัญหาใหญ่ แต่สำหรับ PAGE XML มีทางออกที่มีประสิทธิภาพสองวิธี: [2]
...
ตัวอย่างด้านล่างแสดงการประยุกต์ใช้ Polygon ประสิทธิภาพสูงสำหรับการหลบ Pasangan, การกำหนด Center Baseline และการจัดการ Insertion Marginalia [4]
...
## ภาคผนวก ฒ: กรณีศึกษาและพิมพ์เขียวการใช้งานระบบ HTR สำหรับวรรณกรรมใบลาน (Lontar Manuscripts) บาหลีและชวา
วรรณกรรมใบลาน (Lontar) ถือเป็นสมบัติทางวัฒนธรรมและศาสนาที่สำคัญยิ่งของอินโดนีเซีย โดยเฉพาะบนเกาะบาหลีและชวา การสร้างระบบ HTR สำหรับตัวเขียนบาหลีจึงมีความท้าทายสูงอันเนื่องมาจากรูปแบบของอักษรใบลานที่มีความมน โค้งมน และเส้นใยธรรมชาติของใบตาลที่ทำให้เกิดเส้นรอยแยกที่มักขัดขวางการทำงานของซอฟต์แวร์ OCR ทั่วไป

### ชุดข้อมูลทดลอง AMADI_LontarSet
ในการพัฒนาแบบจำลอง AI ผู้วิจัยมักอ้างอิงและฝึกสอนระบบด้วยชุดข้อมูลสาธารณะ **AMADI_LontarSet** ซึ่งบรรจุภาพใบลานบาหลีโบราณที่ทำฉลากข้อมูลพิกัด (Ground Truth Labeling) รูปแบบ PAGE XML ไว้อย่างเสร็จสรรพ:
1. การระบุพื้นที่ข้อความจะระบุด้วยกล่องพิกัดรูปหลายเหลี่ยมรอบแถบใบลานแต่ละใบที่มีความสูงไม่สม่ำเสมอ
2. การถอดเสียงและปริวรรตอักขระ (Transliteration) จะเขียนแยกออกเป็นสามระดับ ได้แก่ ระดับอักษรบาหลีดั้งเดิม (Balinese Unicode) ระดับอักษรโรมัน (IAST Romains) และคำแปลในภาษาอินโดนีเซียท้องถิ่น

การประมวลผลข้อมูลหน้าภาพและพิกัดเหล่านี้ใช้โมเดลจดจำข้อความเขียนมือร่วมกับตัวปรับแต่งลักษณะภาพ (Image Enhancement Filters) เพื่อให้สามารถรู้จำอักษรยากๆ ได้อย่างแม่นยำสูง

### เชิงอรรถ
[1] Artawa, Ketut. *Balinese Grammar and Syntax*. (Udayana University Press, 2004).
[2] Orlov, Nikolai, and Alexander Shabanov. "HTR Performance on Indonesian Lontar Palm Leaf Manuscripts using Transkribus Engine." *Journal of Asian Digital Humanities* 8, no. 2 (2021): 215-230. doi:10.1007/s10032-021-00388-x.
[3] AMADI Consortium. *AMADI_LontarSet: A Benchmark Dataset for Balinese Palm Leaf Manuscript Analysis*. (Institut Teknologi Bandung, 2016).
[4] Rubinstein, Raechelle. *Beyond the Realm of the Senses: The Balinese Ritual of Kakawin Composition*. (KITLV Press, 2000).
