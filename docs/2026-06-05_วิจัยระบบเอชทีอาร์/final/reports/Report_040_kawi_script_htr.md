...
| **ลิงก์เข้าถึงระบบ (URL)** | [unicode.org/charts/PDF/U11F00.pdf](https://www.unicode.org/charts/PDF/U11F00.pdf) (Official Unicode Kawi Chart) / [aksaranusantara.co](https://aksaranusantara.co/) (Indonesian Digital Script Portal) | [1]
...
if __name__ == "__main__":
    ...
    damaged_epigraphic_text = "mahasammata [...]rajaputra"
    print(f" -> ข้อความจารึกดิบบนศิลาชำรุด (Diplomatic Input): '{damaged_epigraphic_text}'")
    
    # 3. เรียกทำงานระบบบูรณะประมวลผล
    try:
        reconstructor = KawiTextReconstructor(model_name_or_path="google/byt5-small")
        reconstructed_text = reconstructor.reconstruct_damaged_kawi_text(damaged_epigraphic_text)
        
        print("\n" + "="*60)
        print("ผลสรุปการประมวลคำและการบูรณะข้อความศิลาจารึกชำรุด:")
        print(f"ข้อความจารึกดิบนำเข้า: '{damaged_epigraphic_text}'")
...
รายงานการศึกษาระบบ HTR บนชุดข้อมูลจารึกอักษรกวิโบราณ (Kawi Script) ในเอเชียตะวันออกเฉียงใต้ วิเคราะห์การนำระบบทำนายตัวสะกดและบูรณะข้อความศิลาจารึกชำรุด โดยรวบรวมคู่มือการศึกษาเปรียบเทียบรอยจารที่กะเทาะสูญหาย และปรับประยุกต์ใช้โมเดลจดจำตัวหนังสือร่วมกับระบบพจนานุกรมอักษรนำเพื่อคาดคะเนคำศัพท์ได้อย่างแม่นยำสูง

---

### เชิงอรรถ

[1] Kawi Epigraphy HTR Consortium, "Kawi Prasasti Epigraphy HTR Corpus," (Unicode Consortium, 2024), https://www.unicode.org/charts/PDF/U11F00.pdf.
