...
> **วิเคราะห์โดย:** Michael Zhang, Elise Wang, Charlotte Whatley, Seth Strickland, and Dylan Bannon (Medieval Europe Research Branch)  
...
โครงการ **TRIDIS (2025/2026)** หรือโครงการภายใต้หัวข้อวิจัย **"Democratizing the Medieval English Legal Tradition"** นำโดยคณะผู้วิจัย Michael Zhang, Elise Wang, Charlotte Whatley, Seth Strickland, and Dylan Bannon และคณะ ทำหน้าที่พัฒนาคลังข้อมูลจารึกดิจิทัลที่ก้าวหน้าที่สุดสำหรับการถอดความและวิเคราะห์เอกสารกฎหมายอังกฤษและภาษาละตินยุคกลางตอนปลาย (Late Medieval English and Latin Legal Manuscripts) ในช่วงคริสต์ศตวรรษที่ 12 ถึง 16 โครงการนี้มุ่งแก้ไขปัญหาการเข้าถึงเอกสารจดหมายเหตุทางกฎหมายขนาดใหญ่ เช่น ม้วนคัมภีร์บันทึกคำพิพากษาศาล (Plea Rolls) และหนังสือรวบรวมคำพิพากษารายปี (Yearbooks) ซึ่งถูกบันทึกด้วยอักษรตัวเขียนหวัดในราชสำนักที่ซับซ้อน (Court Hand) และประกอบด้วยรอยย่อจำนวนมาก (Abbreviation) [1]
...
การเตรียมข้อมูลจากเล่มจดหมายเหตุโบราณสู่โมเดลปัญญาประดิษฐ์ มีกระบวนการควบคุมคุณภาพที่เข้มงวดแสดงดังแผนภาพสถานะด้านล่างนี้: [2]
...
class TridisHtrPipeline:
    def __init__(self, model_name_or_path="microsoft/trocr-base-handwritten"):
        ...
        """
        print(f"[INFO] กำลังโหลดแบบจำลองจากคลัง: {model_name_or_path}# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน")
    ...
    def run_htr_inference(self, image_path):
        ...
        print("[INFO] กำลังรันกระบวนการประมวลผลรู้จำคำตัวเขียนโบราณ# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน")
        with torch.no_grad():
...
if __name__ == "__main__":
    print("เริ่มกระบวนการรันสคริปต์จำลองทดสอบ HTR ของโครงการ TRIDIS# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน")
...
[1] Michael Zhang, Elise Wang, Charlotte Whatley, Seth Strickland, and Dylan Bannon, "Democratizing the Medieval English Legal Tradition: Large-Scale HTR and VLM Integration," arXiv preprint arXiv:2605.00977 (2026), https://arxiv.org/abs/2605.00977.
[2] Sergio Torres Aguilar, "HTR pipelines for medieval Latin charters," Journal of Digital Humanities 10 (2023): 45-67.
