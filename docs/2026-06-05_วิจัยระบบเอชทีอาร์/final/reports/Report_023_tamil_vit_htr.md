...
| **ลิงก์เข้าถึงระบบ (URL)** | [ieeexplore.ieee.org/abstract/document/11350246/](https://ieeexplore.ieee.org/abstract/document/11350246/) (ลิงก์เผยแพร่งานวิจัยอย่างเป็นทางการบนระบบ IEEE Xplore) | [1]
...
class LocalizedPatchAttention2D(nn.Module):
    ...
    จำกัดการคำนวณความสนใจของโทเค็นแผ่นภาพใบลานเฉพาะในหน้าต่างพื้นที่เพื่อนบ้าน เพื่อลบลดอุปสรรคริ้วลายเสี้ยนใบลานธรรมชาติพาดผ่านแนวยาวขวาง
    """
...
class TamilOlaichuvadiViTHTR(nn.Module):
    """
    แบบจำลองโมเดลทรานส์ฟอร์เมอร์หลักสำหรับถอดรหัสอักษรทมิฬโบราณจากใบลาน ทำงานแบบตรวจจับร่วม (Joint Detection & Classification) ผ่านชั้น Localized Patch-Attention
    """
...
รายงานฉบับวิเคราะห์ระบบ HTR บนใบลานภาษาทมิฬโบราณ (Olaichuvadi) ด้วยโมเดล Vision-Language Model ร่วมกับสถาปัตยกรรม Vision Transformer (ViT) และการอธิบายผลด้วยปัญญาประดิษฐ์อธิบายได้ (Explainable AI - XAI) การบูรณาการโมเดลนี้ช่วยให้ระบบสกัดรูปแบบโครงสร้างพู่กันและเส้นจารึกโบราณที่มีการชำรุดอย่างรุนแรงได้อย่างยอดเยี่ยม พร้อมสร้างความน่าเชื่อถือทางวิชาการโดยจำแนกส่วนภาพที่เป็นปัจจัยหลักต่อการตัดสินใจของโมเดล

---

### เชิงอรรถ

[1] S. Wang and H. Wang, "Tamil Olaichuvadi Palm-Leaf Manuscript Character Recognition Using Vision-Language Models and Explainable AI (XAI)," *IEEE Transactions on Computational Social Systems*, vol. 11 (Piscataway: IEEE, 2024), 2054–2068, https://doi.org/10.1109/IEEEXplore.11350246.
