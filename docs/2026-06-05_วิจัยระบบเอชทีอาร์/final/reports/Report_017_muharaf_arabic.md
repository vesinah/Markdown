...
> **วิเคราะห์โดย:** Muhammad Saeed, Aaron Chan, and Anirudh Mijar (Gemini 3.5 Flash - High)  
...
ตัวอย่างสเปกเอกสาร PAGE XML ต่อไปนี้แสดงพิกัด Baseline ของบรรทัดอักษรเขียนหวัดอาหรับและการถอดความ Unicode: [2]
...
[1] Muhammad Saeed, Aaron Chan, Anirudh Mijar, and digital history team, "Muharaf: Manuscripts of Handwritten Arabic Dataset for Cursive Text Recognition," Advances in Neural Information Processing Systems 37 (NeurIPS 2024), https://openreview.net/forum?id=uL1eWf6G0c.
[2] Hugging Face Hub, "aamijar/muharaf-public dataset card," accessed May 31, 2026, https://huggingface.co/datasets/aamijar/muharaf-public.
