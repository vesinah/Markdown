...
| **ลิงก์เข้าถึงระบบ (URL)** | [arxiv.org/abs/2502.06172](https://arxiv.org/abs/2502.06172) (ลิงก์เข้าถึงเอกสารวิทยาการวิจัยฉบับเต็มอย่างเป็นทางการบน arXiv) | [1]
...
if __name__ == "__main__":
    ...
    try:
        ...
        # ถอดคำทำนายย้อนกลับโดยหลีกเลี่ยงดัชนีเดี่ยวในวงเล็บเหลี่ยมเพื่อไม่ให้ปะปนกับเชิงอรรถ
        first_batch_idx = 0
        predicted_indices = torch.argmax(output_logits[first_batch_idx], dim=-1).tolist()
...
รายงานการศึกษาระบบ HTR บนชุดข้อมูล Platter ซึ่งเป็นคลังข้อมูลข้อความลายมือหลายระบบอักษรของอินเดีย (Indic Multi-Script) พัฒนาโดยสถาบัน IIIT-H โดยรวบรวมหน้าเอกสารและข้อความเขียนด้วยลายมือในหลากหลายภาษา เช่น อักษรเทวนาครี อักษรเบงกาลี และอักษรทมิฬ รายงานนี้วิเคราะห์สถาปัตยกรรมแบบจำลองการถอดอักษรหลายภาษาและการใช้เทคโนโลยีทำความเข้าใจอักขรวิธีเพื่อการก้าวข้ามข้อจำกัดของระบบประมวลผลลายเส้นเขียนข้ามโดเมนอักษร

---

### เชิงอรรถ

[1] B. V. Kasuba, D. Kudale, R. Bhat, and C. V. Jawahar, "Platter: An Indic Multi-Script Handwritten Text Recognition Dataset," in *Proceedings of the International Conference on Document Analysis and Recognition (ICDAR)*, (Cham: Springer, 2025), https://arxiv.org/abs/2502.06172.
