...
| **ผู้แต่ง (Authors)** | George Retsinas, Giorgos Sfikas, Basilis Gatos, and Christophoros Nikou |
| **สถาบัน (Institutions)** | University of Ioannina and National Center for Scientific Research Demokritos, Greece |
...
### 1.1 ภาพรวมโปรเจกต์
การสร้างระบบ HTR ที่มีเสถียรภาพสูงในทางปฏิบัติมักต้องเผชิญกับทางเลือกด้านสถาปัตยกรรมและการตั้งค่าตัวแปรจำลองที่ซับซ้อน งานวิจัยปี 2024 โดย George Retsinas และคณะ ได้วิเคราะห์เปรียบเทียบเชิงประจักษ์เพื่อกำหนด **แนวปฏิบัติที่ดีที่สุด (Best Practices)** สำหรับการออกแบบระบบ HTR แบบลายเส้นตรง (Line-based HTR) ที่มีประสิทธิภาพสูงสุด [1]

### 1.2 สาระสำคัญและทิศทางการประเมิน-วิเคราะห์การเลือกข่ายงานหลักสำหรับสกัดฟีเจอร์วิสัยทัศน์ (CNN Backbone เช่น ResNet หรือ VGG)
- เปรียบเทียบผลลัพธ์ของโมเดลภาษาระดับบรรทัดและระบบควบคุมสัญญาณลำดับ (RNN vs Transformer)
- แนะนำกระบวนการฝึกโมเดลที่มีความยืดหยุ่นต่ออัตราส่วนรูปภาพ (Aspect ratio padding) และการปรับแต่งการกระจายตัวของข้อมูลลายมือ [1]
...
[1] Retsinas, George, Giorgos Sfikas, Basilis Gatos, and Christophoros Nikou. "Best Practices for a Handwritten Text Recognition System." *arXiv preprint arXiv:2404.11339* (2024). https://arxiv.org/abs/2404.11339.
[2] Retsinas, George. "HTR-best-practices: Open-source Implementation and Evaluation Tools." GitHub, 2024. https://github.com/georgeretsi/HTR-best-practices.
