...
| **ผู้แต่ง (Authors)** | Carlos Garrido-Munoz, Antonio Rios-Vila, and Jorge Calvo-Zaragoza |
| **สถาบัน (Institutions)** | University of Alicante, Spain |
...
### 1.1 ภาพรวมโปรเจกต์
ในรอบทศวรรษที่ผ่านมา เทคโนโลยีการจดจำข้อความลายมือ (Handwritten Text Recognition หรือ HTR) ได้เปลี่ยนผ่านจากระบบแยกองค์ประกอบแบบคลาสสิกสู่สถาปัตยกรรมแบบเรียนรู้ปลายชนปลาย (End-to-End Deep Learning) เปเปอร์สำรวจฉบับปี 2025 โดย Carlos Garrido-Munoz และคณะ ได้สังเคราะห์ภาพรวมเทคโนโลยีล่าสุด แนวโน้ม ทิศทางในอนาคต และชุดข้อมูลมาตรฐานสากล [1]

### 1.2 ลักษณะโครงสร้างของระบบ HTR
การประเมินสถาปัตยกรรม HTR ยุคใหม่ระบุถึงส่วนประกอบหลัก:
- โมเดลตรวจจับข้อความและแยกแยะ Layout ของเอกสาร (Layout Analysis & Segmentation)
- ระบบถอดภาพข้อความเป็นตัวอักษร โดยแบ่งเป็นกลุ่ม CTC-based และกลุ่ม Sequence-to-Sequence (Encoder-Decoder)
- ส่วนการประมวลผลหลังการอ่านเพื่อแก้คำผิดด้วยภาษาจำลอง (Language Models) [1]
...
เปเปอร์แบ่งสถาปัตยกรรม End-to-end (ยุค Deep Learning) ออกเป็น 3 กลุ่มใหญ่ ดังแผนภาพด้านล่าง: [2]
...
- ลายมือที่เขียนซ้อนทับกันมาก-เอกสารที่ไม่มีเส้นบรรทัดชัดเจน (Free-form layouts)
...
[1] Garrido-Munoz, Carlos, Antonio Rios-Vila, and Jorge Calvo-Zaragoza. "Handwritten Text Recognition: A Survey." *arXiv preprint arXiv:2502.08417* (2025). https://arxiv.org/abs/2502.08417.
[2] Rios-Vila, Antonio, et al. "State of the Art in Document Layout Analysis and Text Recognition Pipeline." University of Alicante, 2025.
