...
| **ผู้แต่ง (Authors)** | Adilazuarda, M. F., Wijanarko, M. I., Susanto, L., Nur'aini, K., Wijaya, D. T., & Aji, A. F. |
| **สถาบัน (Institutions)** | Monash University Indonesia and Mohamed bin Zayed University of Artificial Intelligence (MBZUAI) |
...
### 1.1 ภาพรวมโปรเจกต์
**NusaAksara** เป็น Benchmark ที่ถูกออกแบบมาเพื่อทดสอบโมเดล AI ในการทำความเข้าใจ "อักษรพื้นเมืองอินโดนีเซีย (Indonesian indigenous scripts หรือ Aksara)" งานวิจัยชิ้นนี้จัดทำขึ้นเพื่อแก้ปัญหาการเสื่อมสูญ of อักษรพื้นถิ่น ซึ่งกำลังถูกแทนที่ด้วยอักษรโรมัน (Romanization) โปรเจกต์นี้มีความทะเยอทะยานมาก เนื่องจากครอบคลุมทั้งรูปภาพ (Vision) และข้อความ (Text) ของ **8 อักษรท้องถิ่นใน 7 ภาษา** [1]
...
- สระและพยัญชนะที่เขียนซ้อนทับหรือต่อกันเป็นกลุ่มคำ (คล้ายอักษรขอม) ส่งผลให้การแยกคำยากขึ้น [1]
- บางภาษาไม่มีการเว้นวรรคระหว่างคำ (Continuous script) ซึ่งสร้างความยุ่งยากในการใช้โทเค็นไนเซอร์ (Tokenizer) มาตรฐาน [1]
- มีอักษรบางชนิด เช่น Lampung ที่ยังไม่รองรับในระบบ Unicode ทำให้เกิดปัญหาการประมวลผลข้อมูลในคอมพิวเตอร์อย่างรุนแรง [1]
...
ภาพถ่ายใน NusaAksara คัดสรรมาจากโครงการอนุรักษ์เอกสารโบราณระดับภูมิภาค รวมถึงคลังข้อมูล AMADI (Aksara Nusantara Manuscript Digital Initiative) โดยนำภาพเอกสารประวัติศาสตร์ของชวา บาหลี และภาษาสิงหลมาทำความสะอาดและจัดหมวดหมู่ใหม่ [1]

### 2.2 Pre-processing
ผู้วิจัยเลือกใช้เทคนิคการลดขนาดภาพและปรับความเปรียบต่างระดับพิกเซลด้วย CLAHE (Contrast Limited Adaptive Histogram Equalization) เพื่อให้รายละเอียดเส้นอักษรบาหลีและชวามีความเด่นชัดบนเอกสารที่ชำรุดเสียหาย [1]
...
| Parameter | ค่า |
|---|---|
| Learning Rate | Zero-shot Evaluation |
| Batch Size | N/A (Evaluated Zero-shot) |
| Epochs | N/A (Evaluated Zero-shot) |
| Optimizer | N/A (Evaluated Zero-shot) |
...
- Metrics มาตรฐานอื่นๆ เช่น WER และ IoU (Intersection over Union สำหรับ Segmentation) เพื่อใช้วัดความแม่นยำของการแยกเขตพื้นที่อักษร [1]

### 4.2 ผลลัพธ์เชิงปริมาณ
จากการประเมินแบบ Zero-shot ของโมเดล VLM ขนาดใหญ่อย่าง GPT-4o และ Aya 23 พบว่าประสิทธิภาพในการสกัดอักษรพื้นถิ่นมีระดับความแม่นยำที่เกือบเป็นศูนย์ (Near-zero performance) โดยมีค่า CER สูงกว่า 85% เนื่องจากความล้มเหลวในการจดจำอักษรซ้อนทับ [1]

### 4.3 Error Analysis
สาเหตุที่ทำให้โมเดลได้คะแนนเกือบศูนย์:
1. **Out of Vocabulary (OOV) และ Unicode Issues:** อักษรบางตัว (เช่น Lampung) ยังไม่ถูกเข้ารหัสใน Unicode ทำให้โมเดลมองเห็นเป็นตัวอักษรขยะ (Mojibake) [1]
2. **Zero-shot Incapability:** โมเดลไม่สามารถประยุกต์ทักษะการอ่านอักษรละตินมาใช้อ่านอักษรซ้อนทับได้ และไม่มีคลังข้อมูลภาษาเหล่านั้นในชุดเทรนดั้งเดิม [1]
...
### 5.1 ความท้าทายด้านเอกสาร-การขาดมาตรฐาน Unicode ทำให้ไม่สามารถรันงานวิจัยด้าน Text Processing ได้เลย
...
[NusaAksara Hugging Face Dataset](https://huggingface.co/datasets/NusaAksara/NusaAksara)
...
[1] Adilazuarda, Muhammad Farid, Musa Izzanardi Wijanarko, Lucky Susanto, Khumaisa Nur'aini, Derry Tanti Wijaya, and Alham Fikri Aji. "NusaAksara: A Multimodal and Multilingual Benchmark for Preserving Indonesian Indigenous Scripts." *arXiv preprint arXiv:2502.18148* (2025). https://arxiv.org/abs/2502.18148.
