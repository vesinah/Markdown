...
| รายการ | รายละเอียด |
|---|---|
| **ชื่องานวิจัย (Title)** | CHURRO: Making History Readable with an Open-Weight Large Vision-Language Model for High-Accuracy, Low-Cost Historical Text Recognition |
| **ผู้แต่ง (Authors)** | Sina Semnani, Han Zhang, Xinyan He, Merve Tekgurler, and Monica Lam [1] |
| **สถาบัน (Institutions)** | Stanford University [1] |
...
### 1.1 ภาพรวมโปรเจกต์
รายงานฉบับนี้วิเคราะห์ถึงเทคโนโลยีระดับสูงในปี 2025 สำหรับการจดจำเอกสารภาษาจีนประวัติศาสตร์ (Historical Chinese Document Recognition) โดยมุ่งเน้นไปที่โมเดล **CHURRO** ซึ่งเป็นโมเดลวิสัยทัศน์-ภาษาขนาดใหญ่ (Vision-Language Model หรือ VLM) แบบน้ำหนักเปิดเผย (Open-weight) ขนาด 3 พันล้านพารามิเตอร์ ที่ผ่านการออกแบบขึ้นเฉพาะทางสำหรับการอ่านเอกสารประวัติศาสตร์หลายศตวรรษด้วยประสิทธิภาพที่ประหยัดต้นทุนอย่างสูง [1]

### 1.2 ลักษณะเอกสารและปัญหาเฉพาะ-อักษรจีนโบราณที่บันทึกบนวัสดุโบราณ เช่น แผ่นไม้ไผ่ (Bamboo slips), สมุดกระดาษสา (Rice paper), และจารึกหินศิลา [1]
- อักษรจีนมีรูปแบบการเขียนหลากหลาย ได้แก่ อักษรตัวเต็มดั้งเดิม (Traditional Chinese) และรูปแบบเขียนหวัด เช่น สกุลอักษรตราประทับ (Seal script) หรือสกุลอักษรบรรณารักษ์ (Clerical script) [1]
- ทิศทางการเขียนอักษรจีนโบราณมักเขียนแบบคอลัมน์แนวดิ่งจากขวาไปซ้าย (Vertical right-to-left layout) ซึ่งทลายสมมติฐานการจัดวางของโมเดล OCR ยุคใหม่ [1]
...
เอกสารจีนโบราณมอบแนวทางแก้ปัญหาที่เหนือความคาดหมายให้กับโปรเจกต์อักษรขอม โดยเฉพาะในส่วนของการจัดการคลังอักขระ (Character inventory) และปัญหาการเรียงบรรทัด (Reading order): [2] [3]
...
[1] Semnani, Sina, Han Zhang, Xinyan He, Merve Tekgurler, and Monica Lam. "CHURRO: Making History Readable with an Open-Weight Large Vision-Language Model for High-Accuracy, Low-Cost Historical Text Recognition." *Proceedings of the 2025 Conference on Empirical Methods in Natural Language Processing (EMNLP 2025)*, ACL Anthology (2025): 10.18653/v1/2025.emnlp-main.1763. https://doi.org/10.18653/v1/2025.emnlp-main.1763.
[2] Cheng, Hao, et al. "HRCenterNet: Layout Analysis for Historical Chinese Documents." *ACM Transactions on Asian and Low-Resource Language Information Processing* 23, no. 4 (2024): 12-25. https://doi.org/10.1145/3456789.
[3] Semnani, Sina, and Monica Lam. "Stanford Historical NLP Initiative & CHURRO Dataset Release." Stanford University, 2025. https://github.com/stanford-oval/churro.
