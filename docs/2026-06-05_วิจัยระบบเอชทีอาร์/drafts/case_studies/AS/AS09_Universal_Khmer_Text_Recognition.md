...
| **ผู้แต่ง (Authors)** | Marry Kong, Rina Buoy, Sovisal Chenda, Nguonly Taing, Masakazu Iwamura, and Koichi Kise |
| **สถาบัน (Institutions)** | Osaka Metropolitan University, Japan and Royal University of Phnom Penh, Cambodia |
...
### 1.1 ภาพรวมโปรเจกต์
เอกสารและจารึกอักษรเขมรเป็นต้นน้ำที่ส่งอิทธิพลต่ออักขระอักษรขอมในใบลานไทย ในเดือนกุมภาพันธ์ 2026 นักวิจัยนำโดย Marry Kong และคณะ ได้นำเสนอแนวทาง **Towards Universal Khmer Text Recognition (UKTR)** บน arXiv เพื่อสร้างกรอบการจดจำข้อความเขมรแบบสากลที่ครอบคลุมหลากหลายลักษณะภาพ (เช่น ลายมือเขียน, เอกสารสิ่งพิมพ์, และข้อความในฉากหลัง) ภายในโมเดลเดียว [1]

### 1.2 ลักษณะเอกสารและปัญหาเฉพาะ-อักษรเขมรมีระบบพยัญชนะซ้อนหรือ "ตัวเชิง" (Subscripts) ที่ห้อยด้านใต้พยัญชนะตัวนำ-สระลอยและตัวอักษรซ้อนกันสองหรือสามชั้น ทำให้ตัวอักษรมีความหนาและความสูงไม่คงที่-การทำ OCR เอกสารเขมรดั้งเดิมมักประสบปัญหาการขาดแคลนข้อมูลสำหรับโมเดลเฉพาะทาง [1]
...
### 5.1 ความท้าทายด้านเอกสาร-การอ่านลายมือเขียน (Handwritten Text) ของภาษาเขมรยังเป็นหมวดหมู่ที่ท้าทายที่สุดเนื่องจากตัวเชิงที่เขียนติดกันจนแทบไม่เหลือช่องว่าง ทำให้โมเดลเดาคำพลาด (Segmentation error)

### 5.2 ความท้าทายด้านเทคนิค-การเทรน 3 โมเดลแยกกันทำให้สิ้นเปลือง Memory และเมื่อนำไปใช้จริงบนระบบ Production จะต้องมีตัวคัดแยกภาพก่อน (Router) ว่าเป็นภาพประเภทใด การเปลี่ยนมาใช้ UKTR ช่วยลดภาระส่วนนี้ไปได้ 100%
...
โปรเจกต์ UKTR ถือเป็น "กรณีศึกษาที่ตรงเป้าที่สุด" สำหรับโปรเจกต์อักษรขอมของเรา เนื่องจากอักษรขอมมีวิวัฒนาการและการจัดวางตัวซ้อนทับ (เชิง) คล้ายคลึงกับอักษรเขมรในปัจจุบันมาก โดยมีบทเรียนเชิงวิศวกรรมดังนี้: [2] [3]
...
[1] Kong, Marry, Rina Buoy, Sovisal Chenda, Nguonly Taing, Masakazu Iwamura, and Koichi Kise. "Towards Universal Khmer Text Recognition." *arXiv preprint arXiv:2603.00702* (2026). https://arxiv.org/abs/2603.00702.
[2] Kong, Marry, et al. "Towards Khmer Scene Document Layout Detection." *arXiv preprint arXiv:2603.00707* (2026). https://arxiv.org/abs/2603.00707.
[3] EFEO. "The Sleuk Rith Project: Digitization and Conservation of Khmer Palm Leaf Manuscripts." Ecole francaise d'Extreme-Orient, 2024. http://www.efeo.fr/sleukrith.
