...
| รายการ | รายละเอียด |
|---|---|
| **ชื่องานวิจัย (Title)** | myMNIST: Benchmark of PETNN, KAN, and Classical Deep Learning Models for Burmese Handwritten Digit Recognition |
| **ผู้แต่ง (Authors)** | Ye Kyaw Thu, Thazin Myint Oo, and Thepchai Supnithi |
| **สถาบัน (Institutions)** | National Electronics and Computer Technology Center (NECTEC) and Waseda University |
...
### 1.1 ภาพรวมโปรเจกต์
เอกสารและคัมภีร์ใบลานภาษาพม่ามีความใกล้ชิดกับอักษรธรรมและอักษรไทยอย่างยิ่ง ในปี 2026 วงการวิจัย HTR ภาษาพม่าได้รับประโยชน์อย่างสูงจากการพัฒนามาตรฐานความแม่นยำใหม่ผ่านโปรเจกต์ **myMNIST** นำโดยนักวิจัย Ye Kyaw Thu และคณะ เพื่อเปรียบเทียบโมเดลตรวจจับอักขระและสถาปัตยกรรมข่ายงานประสาทเทียมหลายตระกูลรวมถึงโมเดลใหม่อย่าง KAN (Kolmogorov-Arnold Network) และ PETNN (Energy Transition Neural Network) [1]

### 1.2 ลักษณะเอกสารและปัญหาเฉพาะ-อักษรพม่ามีลักษณะโครงสร้างเป็นทรงกลม (Circular loops) ซึ่งเขียนหวัดได้ง่าย [1]
- ใบลานพม่ามักเจอปัญหาสิ่งรบกวนบนวัสดุ เช่น รูเจาะสนองและเส้นลายไม้ [2]
- การแบ่งส่วนบรรทัดและกลุ่มพยัญชนะมีความท้าทายเนื่องจากมีสระล้อมรอบทั้งด้านหน้า หลัง บน และล่าง [2]
...
มีการสแกนภาพและเปิดตัว Benchmark ระดับโลกอย่าง **myMNIST** ในช่วงต้นปี 2026 ซึ่งเป็นชุดข้อมูลตัวเลขลายมือพม่า โดยมีตัวแอปพลิเคชันและชุดเครื่องมือจัดเตรียมไว้บนคลังเก็บข้อมูลสาธารณะ [3] สร้างขึ้นเพื่อเทียบเคียงความยากกับชุดข้อมูล MNIST ของตัวเลขอารบิก
...
### 5.4 บทเรียนสำคัญ-รูปทรงของตัวอักษรมีผลต่อการเลือกสถาปัตยกรรม อักษรพม่าที่เป็นวงกลมจะตอบสนองต่อโมเดลสาย Vector (VNN) หรือสายที่ให้ความสำคัญกับรัศมี ได้ดีกว่าโมเดลสายวิเคราะห์ตารางกริด (Grid-based CNN)
...
[1] Ye Kyaw Thu, Thazin Myint Oo, and Thepchai Supnithi. "myMNIST: Benchmark of PETNN, KAN, and Classical Deep Learning Models for Burmese Handwritten Digit Recognition." *arXiv preprint arXiv:2603.18597* (2026). https://arxiv.org/abs/2603.18597.
[2] Htay, H. H., and S. S. Myint. "Text Line Segmentation for Myanmar Palm-Leaf Manuscripts Using Average Linkage Clustering." *ASTES Journal* 10, no. 2 (2025): 112-120. https://doi.org/10.25046/aj100215.
[3] Thu, Ye Kyaw. "Burmese Handwritten Digit Dataset (BHDD) Repository." GitHub, 2026. https://github.com/another-yekyawthu/myMNIST.
