...
XML ย่อมาจาก **eXtensible Markup Language** เป็นภาษามาร์กอัป (Markup Language) ที่มีบทบาทอย่างมากในระบบเทคโนโลยีสารสนเทศปัจจุบัน โดยถูกออกแบบมาเพื่อหน้าที่หลักในการ "จัดเก็บและรับส่งข้อมูล" เป็นสำคัญ โครงสร้างของไฟล์ XML เป็นรูปแบบข้อความธรรมดา (Plain Text) ที่สามารถอ่านเข้าใจได้ง่ายทั้งสำหรับมนุษย์ (Human-readable) และมีความเป็นโครงสร้างที่ชัดเจนจนเครื่องคอมพิวเตอร์สามารถนำไปประมวลผลต่อได้อย่างมีประสิทธิภาพ (Machine-readable) [1]
...
การจะก้าวไปทำความเข้าใจโครงสร้างไฟล์ระดับลึกที่มีความซับซ้อนอย่าง ALTO XML หรือ PAGE XML ผู้ใช้งานและนักพัฒนาโปรแกรมมีความจำเป็นต้องเข้าใจองค์ประกอบพื้นฐานของ XML จำนวน 5 ประการให้ถ่องแท้เสียก่อน: [2]
...
ก่อนที่จะก้าวเข้าสู่การเจาะลึกมาตรฐานไฟล์ XML แต่ละรูปแบบ เราจำเป็นต้องทำความเข้าใจเทคโนโลยีแกนกลางที่มีหน้าที่สกัดข้อความ (Text Extraction) ออกมาจากภาพกระดาษเสียก่อน ซึ่งในโลกวิชาการยุคปัจจุบันได้แบ่งเครื่องมือเหล่านี้ออกเป็น 2 แนวทางหลักตามคุณลักษณะชนิดของเอกสาร ได้แก่ เทคโนโลยี **OCR** และเทคโนโลยี **HTR** [3]
...
เพื่อให้ผู้อ่านสามารถนำข้อมูลไปใช้ตัดสินใจในโครงการวิจัยหรือระบบดิจิทัลของตนเอง นี่คือตารางสรุปเปรียบเทียบมาตรฐาน XML ที่เกี่ยวข้องกับการ Digitization: [4]
...
## ภาคผนวก ก: คู่มือเชิงลึก: สถาปัตยกรรมระบบจัดเก็บข้อมูลดิจิทัลด้วย XML สำหรับคลังสารสนเทศระดับชาติ
ในการออกแบบโครงสร้างพื้นฐานด้านข้อมูลวิชาการสำหรับระบบจดจำอักขระ (OCR/HTR) การเลือกใช้ XML เป็นรูปแบบมาตรฐานในการจัดเก็บเอกสารถือเป็นกลยุทธ์สำคัญที่ช่วยให้ข้อมูลสามารถคงทนอยู่ได้ในระยะยาว (Long-term Digital Preservation) และเอื้อต่อการแลกเปลี่ยนข้อมูลระหว่างระบบต่างๆ (Interoperability) มาตรฐาน XML มีกฎไวยากรณ์ที่เข้มงวดซึ่งช่วยป้องกันข้อผิดพลาดในการประมวลผลข้อมูลขนาดใหญ่ โดยเฉพาะในภาษาไทยและภาษาโบราณของเอเชียที่มีระดับของอักขระที่ซับซ้อน (Combining Characters) การจัดทำเอกสาร XML จึงต้องผ่านกระบวนการตรวจสอบความถูกต้องแบบสองขั้นตอน ได้แก่ ความถูกต้องตามรูปแบบไวยากรณ์พื้นฐาน (Well-formedness) และความสอดคล้องกับข้อกำหนดเฉพาะของโครงสร้างเอกสาร (Validation)

### การตรวจสอบความถูกต้องของ XML
1. **Well-formed XML**: เอกสาร XML ที่เป็นไปตามกฎไวยากรณ์มาตรฐานของ W3C เช่น มีแท็กปิดสำหรับทุกแท็กเปิด การจัดวางแท็กซ้อนกันอย่างถูกต้อง (Correct Nesting) การใช้เครื่องหมายคำพูดรอบค่าคุณลักษณะ (Attributes) และการประกาศ Character Encoding ที่เหมาะสม (แนะนำเป็น UTF-8 เสมอ)
2. **Valid XML**: เอกสาร XML ที่ได้รับการตรวจสอบโครงสร้างตามกฎเกณฑ์ที่กำหนดไว้ใน Document Type Definition (DTD) หรือ XML Schema Definition (XSD) ซึ่งในระบบ OCR/HTR จะใช้ XSD เป็นหลักเนื่องจากรองรับการระบุประเภทข้อมูลที่ซับซ้อน เช่น พิกัดภูมิศาสตร์ (Geometrical Coordinates) และค่าความมั่นใจ (Confidence Score) ของข้อความ

### รหัสตัวอย่างและสเปกเชิงวิชาการ
ด้านล่างนี้เป็นตัวอย่างโครงสร้างไฟล์ XML สำหรับการจัดเก็บข้อมูลการจดจำข้อความภาษาไทยโบราณที่แสดงพิกัดของบรรทัดและคำอย่างสมบูรณ์:
```xml
<?xml version="1.0" encoding="UTF-8"?>
<ocrDocument xmlns="http://www.example.org/ocr/ns"
             xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
             xsi:schemaLocation="http://www.example.org/ocr/ns ocr_standard.xsd">
    <metadata>
        <creator>National Library HTR Project</creator>
        <creationTime>2026-06-05T12:00:00Z</creationTime>
        <language>tha</language>
        <script>Thai</script>
    </metadata>
    <page id="page_001" width="1600" height="2400" imageFile="manuscript_page_001.tiff">
        <textRegion id="r_1" type="paragraph">
            <coords points="100,150 1500,150 1500,2200 100,2200"/>
            <textLine id="line_1">
                <coords points="120,200 1480,200 1480,300 120,300"/>
                <baseline points="120,280 1480,280"/>
                <textEquiv confidence="0.985">
                    <unicode>พระบาทสมเด็จพระพุทธยอดฟ้าจุฬาโลกมหาราช</unicode>
                </textEquiv>
            </textLine>
            <textLine id="line_2">
                <coords points="120,320 1480,320 1480,420 120,420"/>
                <baseline points="120,400 1480,400"/>
                <textEquiv confidence="0.978">
                    <unicode>ทรงสถาปนากรุงเทพมหานครเป็นราชธานี</unicode>
                </textEquiv>
            </textLine>
        </textRegion>
    </page>
...
การประมวลผล XML ในทางปฏิบัติสามารถทำได้ด้วยภาษา Python โดยใช้ไลบรารีมาตรฐาน `xml.etree.ElementTree` หรือ `lxml` ซึ่งมีความเร็วและประสิทธิภาพสูงในการวิเคราะห์ DOM (Document Object Model) ของเอกสารวิชาการขนาดใหญ่

### เชิงอรรถ
[1] Bray, Tim, Jean Paoli, C. M. Sperberg-McQueen, Eve Maler, and François Yergeau, eds. *Extensible Markup Language (XML) 1.0 (Fifth Edition)*. (W3C Recommendation, 2008). https://www.w3.org/TR/REC-xml/.
[2] Harold, Elliotte Rusty, and W. Scott Means. *XML in a Nutshell*. (O'Reilly Media, 2004).
[3] Birnbaum, David J. "What is XML and why should Humanities scholars care?." *Digital Humanities Quarterly* 1, no. 3 (2007): 22-35.
[4] DeRose, Steven J. "Markup systems and future scholarly editing." *Journal of Electronic Publishing* 10, no. 1 (2007). doi:10.3998/3336451.0010.104.
