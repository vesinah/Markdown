...
14. [แหล่งอ้างอิง](#แหล่งอ้างอิง) [1]
...
Element `<Metadata>` ใน PAGE XML ใช้เก็บข้อมูลเกี่ยวกับการสร้างและการแก้ไข Ground Truth [2]
...
การระบุพิกัดใน PAGE XML มีความแม่นยำสูงมาก เพราะถูกออกแบบให้ใช้ **Polygon-based Coordinate System** เป็นหลัก [3]
...
เพื่อแสดงถึงความสมบูรณ์ในการทำงาน ตัวอย่างด้านล่างนี้มีการใช้โครงสร้างที่จำเป็นอย่างหลากหลาย โดยมีการแสดงผลความยาวรวมทั้งหมดให้เห็นลักษณะเชิงลึก [4]
...
### รายละเอียดโค้ดสคริปต์การประมวลผล PAGE XML
```python
import os
...
## ภาคผนวก ค: คู่มือทางเทคนิค: การออกแบบและโครงสร้าง Schema ของ PAGE XML เวอร์ชัน 2019-07-15
มาตรฐาน PAGE (Page Analysis and Ground-truth Elements) XML เป็นโครงสร้างข้อมูลที่ครอบคลุมการจัดเก็บข้อมูลการวิเคราะห์ภาพเอกสารและการสร้าง Ground Truth สำหรับการฝึกฝนระบบ Machine Learning เพื่อการรู้จำอักขระเขียนมือ (Handwritten Text Recognition - HTR) มาตรฐานนี้พัฒนาขึ้นโดยสถาบันวิจัย PRImA Research Lab ณ มหาวิทยาลัยซอลฟอร์ด สหราชอาณาจักร และได้รับการนำไปใช้งานเป็นวงกว้างในเครื่องมือวิชาการ เช่น Transkribus และ eScriptorium

### โครงสร้างระดับสูงสุดของ PAGE XML
เอกสาร PAGE XML เริ่มต้นด้วยแท็กราก (Root Element) `<PcGts>` (Page Content - Ground Truth and Segmentation) ภายใต้เนมสเปซ `http://schema.primaresearch.org/PAGE/gts/pagecontent/2019-07-15` โดยประกอบด้วย 2 แท็กหลักภายใน:
1. **`<Metadata>`**: แสดงข้อมูลเชิงระบบ เช่น ผู้สร้างสรรค์ (Creator) วันเวลาที่สแกน/บันทึกผลงาน และบันทึกประวัติการปรับปรุงข้อความ (LastChange)
2. **`<Page>`**: บรรจุแอตทริบิวต์ระบุชื่อไฟล์ภาพขนาดของภาพ และมีลูกๆ ที่ระบุรายละเอียดพิกัดทางกายภาพ

### การใช้พิกัดรูปหลายเหลี่ยม (Polygons) และ Baseline
สิ่งที่ทำให้ PAGE XML แตกต่างและมีประสิทธิภาพเหนือกว่า ALTO XML ในการประมวลผลเอกสารเขียนมือโบราณคือ:
- **`Polygonal Coordinates`**: การใช้แท็ก `<Coords>` ร่วมกับแอตทริบิวต์ `points` ที่ระบุคู่อันดับพิกัด (X,Y) ต่อกันหลายจุด เช่น `points="100,200 120,180 150,220 180,240 150,300"` ทำให้สามารถสร้างกรอบล้อมรอบตัวเขียนหรือแนวบรรทัดที่เอียง คดเคี้ยว หรือซ้อนทับกันได้อย่างสมบูรณ์ ต่างจาก ALTO XML ที่ถูกจำกัดเฉพาะกรอบรูปสี่เหลี่ยมผืนผ้า (Bounding Box)
- **`Baseline`**: การลากเส้นฐานของตัวอักษรจริงผ่านแท็ก `<Baseline>` ซึ่งมีค่าพิกัดจุดเป็นรูปหลายเหลี่ยมเช่นกัน เส้นนี้มีความสำคัญอย่างยิ่งสำหรับอัลกอริทึมการแปลงอักษร HTR ในอุตสาหกรรมปัจจุบัน เนื่องจากโมเดล Deep Learning (เช่น LSTM หรือ Transformer) ต้องการเส้นบรรทัดฐานในการจัดแนวข้อความ (Normalisation) ก่อนที่จะถอดรหัสออกมาเป็นอักขระจริง

### เชิงอรรถ
[1] Pletschacher, Stefan, and Apostolos Antonacopoulos. "The PAGE (Page Analysis and Ground-Truth Elements) Format for Document Image Analysis." In *Proceedings of the 20th International Conference on Pattern Recognition (ICPR)*, 257-260. (IEEE Computer Society, 2010). doi:10.1109/ICCPR.2010.72.
[2] PRImA Research Lab. *PAGE XML Schema Documentation (Version 2019-07-15)*. (University of Salford, 2019).
[3] Antonacopoulos, Apostolos, Christian Clausner, Christos Papadopoulos, and Stefan Pletschacher. "Historical Document Layout Analysis Competition." In *Proceedings of ICDAR 2013*, 1484-1488. doi:10.1109/ICDAR.2013.298.
[4] Clausner, Christian, Apostolos Antonacopoulos, and Stefan Pletschacher. "Efficient OCR Training Data Generation with PAGE XML." *International Journal on Document Analysis and Recognition (IJDAR)* 21, no. 4 (2018): 255-270. doi:10.1007/s10032-018-0306-x.
