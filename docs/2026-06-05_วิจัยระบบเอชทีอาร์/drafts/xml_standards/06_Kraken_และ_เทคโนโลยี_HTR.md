...
เพื่อให้เห็นภาพที่ชัดเจนที่สุดสำหรับนักพัฒนาและผู้ดูแลระบบ หัวข้อนี้จะแสดงตัวอย่างผลลัพธ์ (Output XML) ที่สร้างจากเครื่องมือ Kraken ในรูปแบบต่างๆ [1]
...
ข้อมูลเบื้องต้นเกี่ยวกับโครงการ Kraken อ้างอิงจากข้อมูลล่าสุด: [2]
...
คำสั่ง `ketos compile` ทำหน้าที่ดึงข้อมูลจากไฟล์ ground truth มาแปลงและบีบอัดให้อยู่ในรูปแบบ Binary Format (`.arrow`) [3]
...
Transkribus เป็นแพลตฟอร์มขนาดใหญ่ที่ผูกพันกับ PAGE XML อย่างลึกซึ้ง [4]
...
## ภาคผนวก ฉ: คู่มือปฏิบัติการ: การสร้างและประมวลผลผลลัพธ์ HTR ด้วย Kraken และ eScriptorium
Kraken เป็นเอนจินรู้จำอักขระแบบโอเพนซอร์สที่ได้รับการออกแบบมาเฉพาะเพื่อตอบสนองต่องานประมวลผลเอกสารอักษรโบราณที่ขาดแคลนข้อมูลสำหรับใช้สอน AI (Under-resourced scripts) โดยมีรูปแบบโครงสร้างการทำงานผ่านอินเทอร์เฟซคำสั่งคอมมานด์ไลน์และการส่งออกพิกัดรูปแบบ PAGE XML หรือ ALTO XML

### แผนภูมิการทำงานของ Kraken Pipeline
ระบบประมวลผลรูปภาพเอกสารของ Kraken จะทำงานเป็นวงจรเชิงเส้น 4 ขั้นตอน:
1. **Binarization**: การปรับปรุงภาพให้เป็นขาวดำ (Bitonal) เพื่อลบสัญญาณรบกวน เช่น คราบรอยเปื้อนหรือกระดาษเหลือง
2. **Layout Analysis**: การแบ่งขอบเขตหน้ากระดาษเป็นพื้นที่ข้อความและตรวจจับตำแหน่งบรรทัดเขียน (Baselines)
3. **HTR Model Inference**: การส่งข้อมูลกล่องบรรทัดอักษรไทยโบราณเข้าไปในโครงข่ายประสาทเทียมชนิด Convolutional-Recurrent Neural Network (CRNN) ร่วมกับโมเดลถอดรหัสภาษาระดับอักขระ
4. **XML Serialization**: การสร้างและเขียนพิกัดพร้อมคำแปลภาษาดั้งเดิมออกเป็นรูปแบบเอกสารตามมาตรฐานวิชาการสากล

เอนจินตัวนี้สามารถเชื่อมประสานกับระบบหน้ากากผู้ใช้ eScriptorium เพื่อช่วยให้นักโบราณคดีหรือนักวิชาการประวัติศาสตร์สามารถช่วยตรวจคำและแก้ไขพิกัดได้อย่างสะดวกบนเว็บบราวเซอร์

### เชิงอรรถ
[1] Kiessling, Benjamin. "Kraken: An Universal Text Recognizer for the Humanities." In *Proceedings of the 2019 Association for Computers and the Humanities Conference*, 12-19. (ACH, 2019).
[2] Kiessling, Benjamin, Robin Tissot, and Peter Stokes. "eScriptorium: An Open Source Platform for Handwritten Text Recognition." *Journal of Open Source Software* 5, no. 53 (2020): 2450. doi:10.21105/joss.02450.
[3] Bluche, Theodore. "Joint Line Segmentation and Transcription for Handwritten Documents." In *Advances in Neural Information Processing Systems (NeurIPS 2016)*, 4817-4825.
[4] Graves, Alex, Santiago Fernandez, and Faustin Gomez. "Connectionist Temporal Classification: Labelling Unsegmented Sequence Data with Recurrent Neural Networks." In *Proceedings of the 23rd International Conference on Machine Learning*, 369-376. (ACM, 2006). doi:10.1145/1143844.1143891.
