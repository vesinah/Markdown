...
| **ลิงก์เข้าถึงระบบ (URL)** | [ifpindia.org](https://www.ifpindia.org/) (Official IFP Portal) / [books.openedition.org/ifp/7481](https://books.openedition.org/ifp/7481) (Official DASI Project Report) | [1]
...
if __name__ == "__main__":
    ...
    mock_estampage_path = os.path.join(scratch_dir, "estampage_line_sample.png")
...
รายงานประเมินและทวนสอบสีกรองกู้คืนกระดาษ DASI Estampage Digitisation Corpus สำหรับระบบจารึกวิทยาอินเดียใต้ วิเคราะห์การใช้สคริปต์แก้ไขเงาสะท้อนและยกระดับคอนทราสต์ของภาพแผ่นสำเนาจารึกด้วยกระดาษลอกสี (Estampage) ซึ่งมักประสบปัญหารอยพับกระดาษ ความลาดเอียงของหินสลัก และความขรุขระของพื้นผิวเพื่อเตรียมข้อมูลสำหรับการสกัดผ่านระบบจดจำข้อความเชิงลึกต่อไป

---

### เชิงอรรถ

[1] French School of Asian Studies (EFEO) and French Institute of Pondicherry (IFP), "DASI South Indian Estampage Digitisation Corpus," (Pondicherry: IFP, 2024), https://books.openedition.org/ifp/7481.
