...
ชุดข้อมูล `sasicodes/tamily-1` เป็นคลังข้อมูลรูปภาพสังเคราะห์มวลขนาดใหญ่ (Large-Scale Synthetic Image Dataset) ระดับสูง ได้รับการออกแบบและพัฒนาขึ้นโดยนักพัฒนาอิสระและวิศวกรปัญญาประดิษฐ์ **Sasi (นามแฝงระบบ: sasicodes)** เพื่อปฏิวัติการฝึกฝนระบบรู้จำอักษรโบราณด้วยแสง (OCR) สำหรับ **อักษรทมิฬโบราณ (Ancient Tamil Script)** ซึ่งประสบปัญหาการขาดแคลนข้อมูลสำหรับสอนระบบ (Data Scarcity) ขั้นรุนแรง [1]
...
ชุดข้อมูลได้รับการจำแนกออกเป็นพาร์ติชันย่อย Config ละ 5,000 เรคคอร์ดเพื่อป้องกันปัญหาหน่วยความจำล้นระหว่างเรียกใช้งาน โดยมีสคีมาตารางข้อมูล Parquet ดังนี้: [2]
...
```json
{
  "split": "train",
  "image": {
    "bytes": "iVBORw0KGgoAAAANSUhEUgAAADIAAAASCAYAAAAe# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน [ตัวอย่างไบนารีเข้ารหัสฐาน 64 ของภาพสังเคราะห์พื้นผิวใบลาน]"
  },
...
[1] Sasi (sasicodes), "Tamily-1: Ancient Tamil OCR synthetic dataset," Hugging Face Dataset Repository, 2026, https://huggingface.co/datasets/sasicodes/tamily-1.
[2] sasicodes, "Tamily-1 synthetic OCR pipeline for ancient scripts," accessed May 31, 2026, https://huggingface.co/datasets/sasicodes/tamily-1.
