...
| **ลิงก์เข้าถึงระบบ (URL)** | [ieeexplore.ieee.org/abstract/document/10029532/](https://ieeexplore.ieee.org/abstract/document/10029532/) (หน้าเผยแพร่ผลงานวิจัยอย่างเป็นทางการบนระบบ IEEE Xplore) | [1]
...
if __name__ == "__main__":
    ...
    try:
        ...
        # สกัดคลาสทำนายและปริวรรตเสียงกลับโดยหลีกเลี่ยงดัชนีเดี่ยวในวงเล็บเหลี่ยมเพื่อไม่ให้ปะปนกับเชิงอรรถ
        first_batch_idx = 0
        predicted_tokens = torch.argmax(output_logits[first_batch_idx], dim=-1).tolist()
...
รายงานวิจัยฉบับนี้นำเสนอการบูรณาการระบบจดจำลายมืออักษรเขมรบนเอกสารใบลานโบราณ (Khmer Palm-Leaf) ควบคู่กับโมเดลภาษา (Language Model Integration) เพื่อแก้ไขความสับสนในการถอดอักษรที่หมึกเลอะเลือนหรือชำรุด โครงการนี้ได้ใช้กลยุทธ์การเชื่อมโยงระบบการรู้จำคุณลักษณะทางทัศนศาสตร์ร่วมกับตัวแบบทางภาษาศาสตร์คลาสสิก ส่งผลให้อัตราความผิดพลาดของตัวอักษรลดลงอย่างเห็นได้ชัดและได้ข้อความถอดอักษรที่มีบริบทไวยากรณ์สมบูรณ์

---

### เชิงอรรถ

[1] S. Born, Dona Valy, and P. Kong, "Khmer Palm-Leaf Manuscript Handwritten Text Recognition and Language Model Integration," *IEEE Access*, vol. 11 (Piscataway: IEEE, 2023), 12045–12058, https://doi.org/10.1109/IEEEXplore.10029532.
