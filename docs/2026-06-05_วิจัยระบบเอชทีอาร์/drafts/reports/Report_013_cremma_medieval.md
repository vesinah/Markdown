...
> **วิเคราะห์โดย:** Ariane Pinche, Thibault Clérice, and Jean-Baptiste Camps, Thibault Clérice, and Jean-Baptiste Camps (Medieval Europe Research Branch)  
...
โครงการ **CREMMA Medieval (2022)** และระบบนิเวศ **CREMMALab** นำโดย ดร. อาเรียน พินช์ (Ariane Pinche, Thibault Clérice, and Jean-Baptiste Camps, Thibault Clérice, and Jean-Baptiste Camps) แห่งสถาบัน École nationale des chartes ถือเป็นความก้าวหน้าครั้งสำคัญในวงการมนุษยศาสตร์ดิจิทัลยุโรป โครงการนี้มีจุดมุ่งหมายหลักในการสร้าง **"แบบจำลองทั่วไปสำหรับการรู้จำตัวเขียน" (Generic HTR Models)** เพื่อแก้ปัญหาขีดจำกัดในการถอดความเอกสารประวัติศาสตร์ภาษาฝรั่งเศสโบราณ (Old French) และภาษาละตินยุคกลาง (Medieval Latin) ในช่วงคริสต์ศตวรรษที่ 12 ถึง 15 ที่มีรูปแบบของตัวเขียนและน้ำหนักมือของอาลักษณ์สะกดที่หลากหลายและไม่มีมาตรฐานที่แน่นอน [1]
...
| **ผู้สร้าง/คณะผู้วิจัย (Creators)** | **ดร. อาเรียน พินช์ (Ariane Pinche, Thibault Clérice, and Jean-Baptiste Camps, Thibault Clérice, and Jean-Baptiste Camps)**, คณะอาจารย์จารึกวิทยา และทีมนักพัฒนา e-Scriptorium |
...
กระบวนการจัดการถ่ายภาพหนังสือโบราณสู่การวิเคราะห์เลย์เอาต์หน้าและการประมวลผล PyLaia แสดงเวิร์กโฟลว์ได้ดังแผนผังสถานะนี้: [2]
...
if __name__ == "__main__":
    print("เริ่มระบบจำลองทดสอบกระบวนการพาร์ส ALTO XML ของโครงการ CREMMA# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน")
...
[1] Ariane Pinche, Thibault Clérice, and Jean-Baptiste Camps, "CREMMA Medieval: Transcription corpora for training HTR models for medieval manuscripts," HTR-United Repository, 2023, https://github.com/HTR-United/cremma-medieval.
[2] SegmOnto Project, "Controlled Vocabulary for Manuscript Layout Segmentation," accessed May 31, 2026, https://github.com/SegmOnto.
