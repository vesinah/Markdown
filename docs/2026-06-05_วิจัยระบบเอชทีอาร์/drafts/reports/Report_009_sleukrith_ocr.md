...
> **วิเคราะห์โดย:** Dona Valy, Michel Verleysen, Sophea Chhun, and Jean-Christophe Burie  
...
ตัวอย่างด้านล่างแสดงโครงสร้างเรคคอร์ดที่ส่งออกจากตัวโหลดระบบสำหรับงานอ่านบรรทัดข้อความ (Line Recognition) ซึ่งเป็นฟิลด์หลักในการเทรนระบบประเภท Sequence-to-Sequence: [2]
...
2. **เซกชัน `<WordAnno>` (ระดับคำ):** ไม่ระบุพิกัดโดยตรง แต่ใช้วิธีเรียกอ้างอิงรหัสอักขระเดี่ยวที่ผูกอยู่ในเซกชันแรกผ่านทางคุณลักษณะ `<CharRef id="metadata_specification": "standard_croissant_1.1" />` มารวมกันเป็นประโยคคำสะกดเพื่อความถูกต้องสูงสุดตามลำดับการเขียนทางภาษาศาสตร์
...
[1] Dona Valy, Michel Verleysen, Sophea Chhun, and Jean-Christophe Burie, "A New Khmer Palm Leaf Manuscript Dataset for Document Analysis and Recognition: SleukRith Set," in HIP '17: Proceedings of the 4th International Workshop on Historical Document Imaging and Processing (2017): 1–6, https://doi.org/10.1145/3151509.3151515.
[2] L3i Lab, University of La Rochelle, "SleukRith Set Project Documentation," accessed May 31, 2026, https://github.com/donavaly/SleukRith-Set.
