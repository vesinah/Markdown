...
> **วิเคราะห์โดย:** Carolyn Jane Anderson, Maeve K. Doyle, and Alexander Brey  
...
ชุดข้อมูลถูกเผยแพร่ในรูปแบบ **Parquet** ผ่านโครงสร้างเมทาดาตาของ **Croissant 1.1** เพื่อช่วยให้ผู้ใช้สามารถนำเข้าสู่ระบบเขียนสคริปต์ Python ในฝั่ง Machine Learning ด้วยไลบรารีชั้นนำ เช่น Pandas, Polars หรือ Hugging Face `datasets` ได้ทันทีโดยไม่ต้องเขียนสคริปต์ล้างข้อมูลใหม่ [2]
...
### 7.3 การจำลองภาพวิเคราะห์เชิงทฤษฎีและกลยุทธ์ข้อมูลป้อนเข้า
ในแง่วิศวกรรมซอฟต์แวร์ปัญญาประดิษฐ์และความทนทานของระบบข้อมูล การนำระบบวิเคราะห์เลย์เอาต์แบบ Semantic Segmentation มาประยุกต์ใช้เพื่อระบุพื้นที่ต่างๆ บนหน้าเอกสาร เช่น ข้อความหลัก ลายขอบประดับประดา หรือรูปวาดจำลองขนาดเล็ก มีความซับซ้อนในการจัดการความเหลื่อมล้ำและรูปร่างที่คดเคี้ยวอย่างอิสระของลายเส้นโบราณ ความท้าทายนี้กระตุ้นให้เกิดการเปลี่ยนผ่านจากการใช้กรอบสี่เหลี่ยมตรวจจับ (Bounding Box) ไปสู่การเขียนหน้ากากกำหนดพิกเซลระดับสูง (Pixel-level Masks) อย่างไรก็ดี การนำหน้ากากสี PNG มาประยุกต์ใช้ในโมเดล ML มีความต้องการในการประมวลผลสูง (High Compute Requirements) และความเป็นไปได้ในการเข้าถึงข้อมูลผ่าน API หรือมาตรฐานความเข้ากันได้ เช่น Croissant 1.1 ช่วยให้โครงการวิจัยด้านมนุษยศาสตร์ดิจิทัลทั่วโลกสามารถทำซ้ำ ตรวจสอบความถูกต้องทางสถิติ และบูรณาการคลังสารสนเทศระดับโลกได้อย่างเป็นระบบ
...
[1] Carolyn Jane Anderson, Maeve K. Doyle, and Alexander Brey, "Networked Borders: A Computational Analysis of Images in the Margins of Gothic Manuscripts" (paper presented at the Manuscript Connections project symposium, 2021), https://manuscriptconnections.org/.
[2] Trinity College Library, Cambridge, "MS O.1.20: Medieval Medical and Surgical Compendium," Trinity College Library Digital Repository, accessed May 31, 2026, https://manuscriptconnections.org/.
