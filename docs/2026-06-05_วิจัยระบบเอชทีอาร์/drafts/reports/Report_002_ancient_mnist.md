...
ชุดข้อมูลเก็บข้อมูลภาพถ่ายแบบ **ไบนารี (Image Bytes)** ควบคู่กับตัวแปรจำนวนเต็ม (Integer) แทนรหัสป้ายจำแนกตัวอักษร [2]
...
- **ลักษณะชื่อตัวอักษรเรียงตามพจนานุกรมอักษรอังกฤษ:** การกำหนด Category Labels ถูกผูกตามความเรียงตัวอักษรอังกฤษ (A ถึง Z) ของชื่อทับศัพท์ภาษากรีก ซึ่งอาจสร้างความสับสนแก่ผู้เชี่ยวชาญด้านนิรุกติศาสตร์โบราณที่คุ้นชินกับการเรียงลำดับดั้งเดิมตามประวัติศาสตร์กรีกแท้ ๆ (เช่น Alpha -> Beta -> Gamma -> Delta -> Epsilon -> Zeta# ข้อมูลแถวเพิ่มเติมได้รับการละเว้นเพื่อความเป็นระเบียบและแสดงผลเชิงตัวแทน)
...
[1] SummerSigh, "AncientMNIST: Ancient Handwritings MNIST-like Benchmark," Hugging Face Dataset Repository, 2026, https://huggingface.co/datasets/SummerSigh/AncientMNIST.
[2] MNIST database contributors, "The MNIST Database of Handwritten Digits," accessed May 31, 2026, http://yann.lecun.com/exdb/mnist/.
