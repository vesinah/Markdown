...
ในการทำดิจิทัลไลเซชัน (Digitalization) เอกสารโบราณหรือหนังสือ เราไม่ได้ต้องการเพียงแค่รูปภาพของเอกสารหรือข้อความดิบ (Plain text) เท่านั้น แต่นักวิจัยในสาขามนุษยศาสตร์ดิจิทัลต้องการ "ความหมาย" แฝงที่อยู่ในข้อความนั้น เช่น การบอกได้ว่าคำใดคือชื่อบุคคล (Person name) คำใดคือชื่อสถานที่ (Place name) โครงสร้างของบทกวีเป็นอย่างไร หรือส่วนใดเป็นเชิงอรรถ (Footnote) ซึ่ง TEI เข้ามาตอบโจทย์ในจุดนี้อย่างสมบูรณ์ ความแพร่หลายของ TEI ทำให้มันกลายเป็นมาตรฐานโดยพฤตินัย (De facto standard) ในวงการมนุษยศาสตร์ดิจิทัล
...
- `<lb/>` (Line Begin): จุดบอกการเริ่มต้นบรรทัดใหม่ของต้นฉบับ
...
การแปลงข้อมูลจาก PAGE/ALTO ไปเป็น TEI จำเป็นต้องมีการวางแผนอย่างเป็นระบบ เพื่อไม่ให้ข้อมูลสูญหายระหว่างการแปลง (Lossless transformation)
...
- **BaseX / eXist-db:** ฐานข้อมูลประเภท Native XML Database ที่เหมาะสำหรับการเก็บไฟล์ TEI จำนวนมหาศาลและรองรับการคิวรี (Query) ข้อมูลด้วยภาษา XQuery
