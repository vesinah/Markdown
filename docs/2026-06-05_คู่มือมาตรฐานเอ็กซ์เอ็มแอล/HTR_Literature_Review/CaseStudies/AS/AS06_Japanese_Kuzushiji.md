...
| **ผู้แต่ง (Authors)** | *[บทสังเคราะห์จากงานวิจัยที่ใช้ Kuzushiji-MNIST และ KuroNet]* |
| **สถาบัน (Institutions)** | Center for Open Data in the Humanities (CODH) และเครือข่ายวิจัยนานาชาติ |
| **แหล่งตีพิมพ์ (Venue)** | arXiv และวารสารวิชาการด้าน Computer Vision |
| **ปีที่ตีพิมพ์** | 2024 - 2025 |
| **DOI/URL** | [Kuzushiji Dataset by CODH](http://codh.rois.ac.jp/kuzushiji/) |
...
### 1.1 ภาพรวมโปรเจกต์
วรรณกรรมญี่ปุ่นโบราณกว่า 3 ล้านเล่มถูกบันทึกด้วยอักษร **"คุซุชิจิ (Kuzushiji)"** ซึ่งเป็นรูปแบบการเขียนหวัดที่คนญี่ปุ่นยุคปัจจุบันอ่านไม่ออกอีกต่อไปแล้ว วงการวิจัย HTR ของญี่ปุ่นก้าวหน้าอย่างมากมาตั้งแต่ปี 2019 โดยมี Dataset มาตรฐานอย่าง `Kuzushiji-MNIST` เป็นสนามประลอง ในปี 2024-2025 ความท้าทายได้ยกระดับจากการทำ Character Recognition ธรรมดา ไปสู่การแก้ไขปัญหาเฉพาะทาง เช่น การกู้คืนตัวอักษรที่ถูกตรายางประทับทับ (Seal interference) และการใช้เสียงอ่าน (Audio) มาช่วยไกด์การทำงานของ AI

### 1.2 ลักษณะเอกสารและปัญหาเฉพาะ
- อักษรคุซุชิจิเป็นตัวหวัด (Cursive) ที่ลากเส้นเชื่อมกันอย่างซับซ้อนตามแนวตั้ง และบางตัวอักษรสามารถเขียนได้หลายรูปแบบ (Multiple allographs)
- ปัญหาที่น่าปวดหัวของเอกสารเอเชียตะวันออก (จีน/ญี่ปุ่น) คือการมี **รอยประทับตรายางสีแดง (Red seals/stamps)** ทับลงบนตัวอักษรสีดำ ทำให้โมเดลเกิดความสับสน (Interference)
...
- การทำ End-to-end ด้วย U-Net (แบบ KuroNet) สะดวกและใช้งานง่ายในโปรดักชัน (เช่น ทำแอปมือถือ Miwo) แต่มันต้องการพลังประมวลผลมหาศาลและ Dataset ที่มีคุณภาพสูงมากๆ
...
บทเรียนจากวงการคุซุชิจิญี่ปุ่นมอบยุทธวิธีที่สามารถนำมาประยุกต์ใช้กับเอกสารสมุดไทยและใบลานขอมในหอสมุดแห่งชาติได้ทันที ใน 2 ประเด็นหลัก:
...
1. Center for Open Data in the Humanities (CODH). *"Kuzushiji Dataset."* [http://codh.rois.ac.jp/kuzushiji/](http://codh.rois.ac.jp/kuzushiji/)
2. สังเคราะห์งานวิจัยการใช้ SFOA และ Multimodal OCR สำหรับ Kuzushiji (2024-2025).
