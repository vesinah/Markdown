...
| **CER/WER ที่ดีที่สุด** | *[ตัวเลขขึ้นอยู่กับโมเดลที่นำมาทดสอบ (Benchmark)]* |
...
### 1.1 ภาพรวมโปรเจกต์
**ThaiOCRBench** เป็น Benchmark แบบครอบคลุมที่พัฒนาโดยทีมวิจัย SCB 10X (Typhoon AI) เพื่อใช้วัดประสิทธิภาพของ Vision-Language Models (VLMs) ทั้งแบบ Proprietary และ Open-source ในการทำความเข้าใจเอกสารภาษาไทย (Thai text-rich visual understanding) เป้าหมายคือการอุดช่องโหว่ของการประเมินผลโมเดล AI ในเอกสารภาษาไทย เนื่องจากภาษาไทยเป็น low-resource language ที่มีโครงสร้างอักษรซับซ้อน 

### 1.2 ภาพตัวอย่างเอกสาร (ลักษณะเอกสาร)
ความท้าทายหลักของเอกสารใน Benchmark นี้คือ:
- **Stacked Diacritics:** สระและวรรณยุกต์ที่ซ้อนกันหลายชั้น (Upper/Lower vowels) 
- **Complex Layouts:** ตาราง, กราฟ, เอกสารราชการที่มีตราครุฑ, แบบฟอร์ม
- **Fine-grained Text:** การสกัดข้อความลายมือที่หวัดและอ่านยากจากแบบฟอร์ม
...
### 2.2 Pre-processing
*ไม่มีข้อมูลระบุใน source (เนื่องจากเป็นชุดภาพพร้อมใช้งานสำหรับการทดสอบ VLMs แบบ End-to-End)*
...
- การไม่มีการเว้นวรรคคำของภาษาไทย ทำให้โมเดลตัดคำ (Tokenization) ผิดพลาดได้ง่าย
- สระซ้อนทับ (Stacked vowels/diacritics) เป็นจุดอ่อนสำคัญของ VLMs

### 5.4 บทเรียนสำคัญ
- การนำ Zero-shot VLMs มาใช้อ่านลายมือภาษาไทย (Handwritten Text) โดยไม่ทำ Fine-tuning ยังคงให้ผลลัพธ์ที่ต่ำเกินกว่าจะนำไปใช้งานจริง (Production)
...
จากผลการวิจัยใน ThaiOCRBench ทำให้เราได้ข้อสรุปที่สำคัญมากในการทำโปรเจกต์ HTR สมุดไทยและคัมภีร์ใบลาน ดังนี้:
...
1. SCB 10X / Typhoon AI. "ThaiOCRBench: A Task-Diverse Benchmark for Vision-Language Understanding in Thai." *Accepted to IJCNLP-AACL*, 2025. [arXiv:2511.04479](https://arxiv.org/abs/2511.04479)
2. SCB 10X. ThaiOCRBench Dataset. Hugging Face, 2025. [URL: https://huggingface.co/datasets/scb10x/ThaiOCRBench](https://huggingface.co/datasets/scb10x/ThaiOCRBench)
3. SCB 10X. ThaiOCRBench Evaluation Toolkit. GitHub, 2025. [URL: https://github.com/scb-10x/ThaiOCRBench](https://github.com/scb-10x/ThaiOCRBench)
