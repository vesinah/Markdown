...
| **ผู้แต่ง (Authors)** | คณะผู้วิจัยที่ตีพิมพ์ใน ACL Anthology (2025) |
...
### 2.2 Pre-processing
*ไม่มีข้อมูลการทำ Image Processing เชิงลึกระบุใน Summary*
...
### 4.1 Metrics ที่ใช้
วัดผลผ่าน CER (Character Error Rate)

### 4.2 ผลลัพธ์เชิงปริมาณ
* ตัวเลขจำเพาะไม่ได้ถูกระบุใน Summary แต่เปเปอร์นี้ได้ประกาศตัวเป็น **State-of-the-Art (SoTA)** สำหรับภาษาเทวนาครีโบราณ
* งานวิจัยยังเปรียบเทียบกับ API เชิงพาณิชย์ และพบว่า **Google Cloud Vision** สามารถเอาชนะโมเดล Open-source ยอดฮิตอย่าง Tesseract หรือ PaddleOCR ได้ราบคาบ เมื่อต้องเจอกับโศลกสันสกฤต (Sanskrit shlokas) ที่มีความซับซ้อน

### 4.3 Error Analysis
ข้อผิดพลาดหลักในอดีต (ก่อนมีโมเดล ByT5 เข้ามาช่วย) เกิดจากการที่ OCR เดาพยัญชนะถูก แต่ใส่เครื่องหมายสระ (Diacritics) พลาดตำแหน่ง หรือแกะตัวอักษรซ้อน (Conjuncts) ผิดตัว
...
|---|---|---|---|
| Dataset | AnciDev | [ACL Anthology (Search Base)](https://aclanthology.org/) | ตีพิมพ์ในปี 2025 |
...
1. *"AnciDev: A Large-Scale Dataset for Ancient Devanagari Manuscript Recognition."* ACL Anthology, 2025.
2. การสังเคราะห์งานวิจัย HTR ภาษาตระกูลอินโด-อารยัน ปี 2024-2025 (CRAFT, ByT5, PARSeq).
