...
| รายการ | รายละเอียด |
|---|---|
| **ชื่องานวิจัย (Title)** | Sinhala OCR and HTR Advancements (SinOCR & Hybrid Architectures 2024-2025) |
| **ผู้แต่ง (Authors)** | ทีมนักวิจัยจาก University of Moratuwa และหน่วยงานพันธมิตร |
| **สถาบัน (Institutions)** | University of Moratuwa, University of Kelaniya (Sri Lanka) |
...
### 1.1 ภาพรวมโปรเจกต์
ประเทศศรีลังกาเป็นหนึ่งในศูนย์กลางของเอกสารทางพุทธศาสนา (เถรวาท) ที่บันทึกบนใบลาน ในช่วงปลายปี 2025 วงการวิจัย AI ของศรีลังกา (นำโดย University of Moratuwa) ได้สร้างหมุดหมายสำคัญด้วยการปล่อย **SinOCR Dataset** ซึ่งเป็นชุดข้อมูลอักษรสิงหลที่ใหญ่ที่สุดในโลก (กว่า 1 แสนภาพ) พร้อมกับผลักดันเทคโนโลยีการวิเคราะห์พื้นผิวใบลานด้วยเทคนิค Gabor Filters เข้ามาเสริมโครงข่ายประสาทเทียม

### 1.2 ลักษณะเอกสารและปัญหาเฉพาะ
- อักษรสิงหลมีลักษณะกลมมนและตวัดโค้ง คล้ายอักษรพม่าและอักษรธรรมล้านนา
- **ปัญหาทางกายภาพ:** ปัญหา "หมึกเปื้อน (Ink smudges)" และ "หมึกซีดจาง (Fading)" รุนแรงมากบนพื้นผิวใบลานอายุหลายร้อยปี
...
1. *"SinOCR: A large-scale dataset and benchmark for Sinhala OCR."* University of Moratuwa, 2025.
2. การสังเคราะห์เทคนิค Gabor-initialized CNN สำหรับใบลาน และ LLM Post-processing (2024-2025).
