...
| **ผู้แต่ง (Authors)** | Jailingeswari, I., & Gopinathan, S. (และคณะวิจัยที่เกี่ยวข้อง) |
| **สถาบัน (Institutions)** | สถาบันวิจัยในประเทศอินเดีย (อ้างอิงจาก Data in Brief, 2024) |
| **แหล่งตีพิมพ์ (Venue)** | Data in Brief (Volume 53) และวารสารวิชาการที่เกี่ยวข้อง |
| **ปีที่ตีพิมพ์** | 2024 - 2025 |
| **DOI/URL** | *[อ้างอิงจากบทความ THPLMD ในฐานข้อมูล NIH/ScienceDirect]* |
...
### 1.1 ภาพรวมโปรเจกต์
รายงานฉบับนี้เจาะลึกถึงความก้าวหน้าล่าสุด (ปี 2024-2025) ในการทำ HTR บน **"คัมภีร์ใบลาน (Palm Leaf Manuscripts)"** โดยมีศูนย์กลางอยู่ที่ชุดข้อมูลมาตรฐานระดับโลกที่เพิ่งถูกปล่อยออกมาอย่าง **TH-PLMD (Tamil Handwritten Palm Leaf Manuscript Dataset)** ชุดข้อมูลนี้ถูกสร้างขึ้นเพื่อทลายข้อจำกัดของการทำ AI อ่านคัมภีร์โบราณ ซึ่งนักวิจัยทั่วโลกมักประสบปัญหาการขาดแคลนรูปภาพใบลานที่มีการทำ Ground Truth ไว้อย่างถูกต้อง
...
1. **Tholkappiyam** (221 ตัวอย่างภาพ)
2. **Naladiyar** (27 ตัวอย่างภาพ)
3. **Thirikadugam** (14 ตัวอย่างภาพ)

**ความท้าทายเฉพาะทางกายภาพ:** 
ใบลานทมิฬมีความเสื่อมสภาพที่ซับซ้อน ได้แก่ การแตกร้าวของใบไม้ (Cracks), การเปลี่ยนสี (Discoloration), ร่องรอยจากความชื้น (Moisture & Humidity), และรอยแมลงเจาะ (Insect damage) ซึ่งทำให้พื้นหลังของภาพมีลักษณะ (Texture) ที่ขัดขวางการทำงานของ OCR แบบดั้งเดิมอย่างรุนแรง
...
*แม้จะไม่มีการระบุ Hyperparameters เป๊ะๆ จากงานชิ้นเดียว แต่มาตรฐานของวงการคือการใช้ Learning rate ที่ต่ำกว่าปกติ (เช่น 1e-5) เพื่อป้องกันไม่ให้โมเดลจำ (Memorize) รอยด่างของใบลานแทนตัวอักษร*
...
### 4.1 Metrics ที่ใช้
วัดผลผ่าน CER (Character Error Rate) สำหรับความแม่นยำระดับรูปร่างตัวอักษร และ WER (Word Error Rate)
...
1. **รอยเจาะร้อยเชือก (Binding Holes):** โมเดลมักเดาว่าบริเวณที่มีรูเจาะเป็นตัวอักษร `O` หรืออักษรที่มีลักษณะกลม
2. **การซ้อนทับของอักษรทมิฬโบราณ (Cursive overlaps):** อักษรที่อยู่ติดกันมากเกินไปทำให้เกิด Segmentation error ได้ง่าย
...
1. Jailingeswari, I., & Gopinathan, S. (2024). *"Tamil handwritten palm leaf manuscript dataset (THPLMD)."* Data in Brief, 53, 110100.
2. การสังเคราะห์เทรนด์เอกสารประวัติศาสตร์เอเชียใต้และวิธีการจัดการปัญหา Noise บนวัสดุใบลาน (2024-2025).
