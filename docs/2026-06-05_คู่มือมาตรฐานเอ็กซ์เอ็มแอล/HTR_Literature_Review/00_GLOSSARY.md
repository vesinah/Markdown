...
**ดูเพิ่ม:** [XML Standards Guide — ALTO](../XML_Standards_Guide/02_ALTO_XML_ประวัติ_โครงสร้าง_Schema.md)
...
**ใช้สำหรับ:** วัดผล layout analysis / segmentation
...
**ดูเพิ่ม:** [XML Standards Guide — PAGE](../XML_Standards_Guide/03_PAGE_XML_ประวัติ_โครงสร้าง_Schema.md)

### Palm Leaf Manuscript (ใบลาน)
**คำอธิบาย:** เอกสารโบราณที่เขียนบนใบตาล (palm leaf) แพร่หลายในเอเชียใต้และเอเชียตะวันออกเฉียงใต้  
**ลักษณะ:** แคบยาว, มักมีรูร้อยเชือก, เสื่อมสภาพง่าย  
