...
ในโครงการดิจิทัล หรือโครงการแปลงเอกสารกระดาษให้อยู่ในรูปแบบดิจิทัล (Digitalization) หนึ่งในความท้าทายที่ยิ่งใหญ่ที่สุดคือการจัดการข้อมูลจำนวนมหาศาลที่เกิดขึ้นจากการสแกนเอกสาร การทำให้เอกสารเหล่านั้นสามารถอ่าน เผยแพร่ และเก็บรักษาได้อย่างยั่งยืนจำเป็นต้องอาศัยมาตรฐานกลาง 
...
ต่อไปนี้คือรายละเอียดเชิงลึกของสถาปัตยกรรมทั้ง 7 ส่วน
...
ใช้ในกรณีที่มีความสัมพันธ์ข้ามไปมาที่ไม่สามารถแสดงด้วยโครงสร้างแบบต้นไม้ (Hierarchical) แบบปกติได้ เช่น ลิงก์จากหน้าสารบัญ (Table of Content) ชี้ไปยังหน้าเนื้อหา, หรือการเชื่อมโยงเนื้อหาที่กระโดดข้ามหน้า (เช่น "อ่านต่อหน้า 50")
...
การกำหนด `TYPE` อย่างชัดเจนช่วยให้ระบบสืบค้น (Search Engine) และระบบ Viewer เข้าใจบริบทของหน้าหรือเนื้อหานั้นๆ ได้ดีขึ้น ว่ากำลังนำเสนอส่วนใดของหนังสือ
