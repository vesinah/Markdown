...
| **ลิงก์เข้าถึงระบบ (URL)** | [arxiv.org/abs/2409.01704](https://arxiv.org/abs/2409.01704) (เปเปอวิจัยหลัก) / [github.com/Ucas-CoCo/GOT](https://github.com/Ucas-CoCo/GOT) (คลังโค้ดและโมเดล) |
...
if __name__ == "__main__":
    ...
    mock_lanna_leaf_path = os.path.join(scratch_dir, "mock_lanna_leaf_1024.jpg")
